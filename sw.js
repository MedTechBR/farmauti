...
const EXT = "fu-ext-v1";
const V = "8";
const PRE = ["./", "index.html", "app.css?v=" + V, "mtfiltro.js?v=" + V, "mtsinal.js?v=" + V, "app.js?v=" + V, "dados/estudo.js?v=" + V, "dados/referencia.js?v=" + V, "manifest.webmanifest", "icons/icon-192.png"];
